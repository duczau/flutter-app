...
class MessageBubble extends StatefulWidget {
  ...
  final ValueChanged<bool>? onSelectionChanged; // ValueChanged 1 dạng như truyền function callback
  @override
  State<MessageBubble> createState() => _MessageBubbleState();
}

class _MessageBubbleState extends State<MessageBubble> {
 // ValueChanged 1 dạng như truyền function callback
  @override
    ...
    List<Widget> text = [
                      Container(
                        decoration: BoxDecoration(
                          color: widget.isMe
                              ? const Color.fromARGB(255, 52, 112, 231)
                ...
                children: [
                  ...
                  Row(
                    ...
                    mainAxisAlignment: widget.isMe
                        ? MainAxisAlignment.end
                        : MainAxisAlignment.start,
                    children: widget.isMe ? text.reversed.toList() : text,
                  ),
                ],
              ),
            ],
